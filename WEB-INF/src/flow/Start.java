 ...
 * code generator.<br>
 * Last generated by Orchestration Designer at: 2020-APR-15  02:11:56 PM
 */
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("start_app");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.PROMPT__COLLECT_FIELD_CONFIDENCE,
			IProjectVariables.PROMPT__COLLECT_FIELD_INPUTMODE,
			IProjectVariables.PROMPT__COLLECT_FIELD_INTERPRETATION,
			IProjectVariables.PROMPT__COLLECT_FIELD_NOINPUTCOUNT,
			IProjectVariables.PROMPT__COLLECT_FIELD_NOMATCHCOUNT,
			IProjectVariables.PROMPT__COLLECT_FIELD_UTTERANCE,
			IProjectVariables.PROMPT__COLLECT_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.PROMPT__COLLECT, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.CALL__DATA_FIELD_TRANSFER__VDN,
			IProjectVariables.CALL__DATA_FIELD_UCID,
			IProjectVariables.CALL__DATA_FIELD_UUI__DATA };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CALL__DATA, variableFields, null, session, false, false );
		session.putVariable(variable);
